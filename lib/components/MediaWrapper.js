...
var MediaWrapper = /*#__PURE__*/function (_Component) {
  ...
  function MediaWrapper(props) {
    ...
    _this._handleFocus = (_context = _this)._handleFocus.bind(_context);
    _this._handleBlur = (_context = _this)._handleBlur.bind(_context);
    return _this;
  }
