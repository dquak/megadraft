...
var _backstageModal = _interopRequireDefault(require("backstage-modal"));

var _ModalPluginList = _interopRequireDefault(require("./ModalPluginList"));
...
var PluginsModal = /*#__PURE__*/function (_Component) {
  _inherits(PluginsModal, _Component);

  var _super = _createSuper(PluginsModal);
  ...
  function PluginsModal(props) {
    ...
    _this.onCloseRequest = (_context = _this).onCloseRequest.bind(_context);
  ...
  _createClass(PluginsModal, [{
    ...
    value: function onCloseRequest() {
      ...
      this.context.onAction({
        type: _constants.PLUGINS_MODAL_CLOSE
      });
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_backstageModal["default"], {
      ...
      }, /*#__PURE__*/_react["default"].createElement(_ModalPluginList["default"], {
...
_defineProperty(PluginsModal, "contextType", _ActionsProvider.ActionsContext);