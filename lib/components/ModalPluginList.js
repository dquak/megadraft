...
var _ModalPluginItem = _interopRequireDefault(require("./ModalPluginItem"));
...
var ModalPluginList = /*#__PURE__*/function (_Component) {
  _inherits(ModalPluginList, _Component);

  var _super = _createSuper(ModalPluginList);
  ...
  function ModalPluginList(props) {
    ...
    _this.modalClose = (_context = _this).modalClose.bind(_context);
  ...
  _createClass(ModalPluginList, [{
    ...
    value: function render() {
      return /*#__PURE__*/_react["default"].createElement(_backstageModal.ModalBody, null, /*#__PURE__*/_react["default"].createElement(_ModalPluginItem["default"], {
