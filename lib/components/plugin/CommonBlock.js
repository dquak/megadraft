...
var CommonBlock = /*#__PURE__*/function (_Component) {
  _inherits(CommonBlock, _Component);

  var _super = _createSuper(CommonBlock);
  ...
  function CommonBlock(props) {
    ...
    _this._handleDisplayChange = (_context = _this)._handleDisplayChange.bind(_context);
    return _this;
  }
  ...
  _createClass(CommonBlock, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_plugin.BlockWrapper, {
        readOnly: readOnly
      }, !readOnly && /*#__PURE__*/_react["default"].createElement(_plugin.BlockControls, null, /*#__PURE__*/_react["default"].createElement(_Dropdown["default"], {
        items: options.displayOptions,
        selected: data.display || options.defaultDisplay,
        onChange: this._handleDisplayChange
      }), /*#__PURE__*/_react["default"].createElement(_plugin.BlockActionGroup, {
